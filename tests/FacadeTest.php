...
{
    public const TWITTER = 'Tweeted: posted from: myblog.com';
    ...
    public function it_can_share_a_blog(): void
    {
        ...
        $facade->share('myblog.com','blog','posted');
        ...
        self::assertSame($expected, $facade->share('myblog.com','blog','posted'));
        self::assertIsArray($facade->share('myblog.com','blog','posted'));
    }
}